    ...
    return (
      <View style={[styles.commentContainer]}>
        <View style={styles.userInfoContainer}>
          <Image source={{ uri: "https://img1.hscicdn.com/image/upload/f_auto,t_ds_square_w_320,q_50/lsci/db/PICTURES/CMS/316600/316647.png" }} style={styles.profile_picture} />
