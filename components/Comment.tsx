  ...
  return (
    ...
    >
      <View style={styles.userInfoContainer}>
        <View style={comment.level !== 0 ? styles.lineContainer : null}></View>
        <Image
          source={{
            uri: comment.postedBy.profile_picture.url || "https://picsum.photos/201"
                  ...
                  <>
                    <Text
                      style={{
                        top: 2,
                        fontSize: 12,
                        color: comment.replies.length > 0 ? "white" : "grey",
                        fontStyle: "italic",
                        bottom: 10,
                      }}
                    >
      ...
      {comment.replies &&
        ...
        comment.replies.map((item: any, index: any) => (
          <View key={item._id.toString()} style={styles.commentContainer}>
            {index !== comment.replies.length - 1 && (
