...
import { StyleSheet, View, Text, Image, TouchableOpacity, Alert, TextInput, Keyboard,
    ...
    <View style={styles.container}>
      ...
      {editMode ? (
        <View>
          <TextInput 
            multiline
            style={{ height: 80, color: "white", marginTop:20}}
            value={editedText}
            onChangeText={(text) => setEditedText(text)}
          />
          
          <TouchableOpacity onPress={handleSave} style={styles.saveButton}><Text>Save</Text></TouchableOpacity>
        </View>
      ) : 
