...
const DetailsTab = (extraProp: any) => {
  const { reviewRating, reviewsCount, zambeelRating, profileDescription } =
    extraProp.extraProp;
  return (
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <View style={{ paddingLeft: 20 }}>
            <StarRating initialValue={reviewRating} />
          </View>
          <Text
            style={{
              color: "white",
          ...
          <Text
            style={{
              color: "white",
              marginLeft: zambeelRating === 0 ? 100 : 80,
              fontSize: 25,
              fontWeight: "bold",
            }}
          >
            {zambeelRating === 0 ? "NA" : `${zambeelRating}/5`}
          </Text>
        </View>
        <Text style={{ color: "#047CD2", marginLeft: 300, fontSize: 15 }}>
          Zambeel
        </Text>
  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        ...
        <TouchableOpacity
          onPress={() => {
            navigation.navigate("AddInstructorReview", {
              name: name,
...
const InstructorDetails = ({ route }: any) => {
  ...
  const onDeleteSuccess = () => {
    // callback function to refresh reviews
    fetchData();
  };
          ...
          <TabView
            ...
            renderTabBar={(props) => (
              <TabBar
                ...
                indicatorStyle={{ backgroundColor: "#35C2C1" }}
              />
            )}
          />
        </View>
